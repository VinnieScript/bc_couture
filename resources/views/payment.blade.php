...
.StripeElement--webkit-autofill {
  background-color: #fefde5 !important;
        ...
        <div id="banner1" style="width:100%;position:absolute;z-index:0.5; height:170px;background-color:#e9e9e9;  border:0px solid #000">
           ...
           <div style="margin-left:5%;margin-top:5px;float:left"><img src="{{asset('images/cart.png')}}" width="40px"/></div><div style="font-family:candara;float:left;margin-top:2px;margin-left:5px">Shopping Cart<br/><span style="font-weight:bold;font-size:1.5em; cursor:pointer" id="viewcart"> </span><span>items</span></div>
           </div>
          
           
           </div>
           <div  id="formBody" style="width:100%;height:100% ;color:#000;margin-top:250px;" align="center">
           <h1>Use Stripe Online payment platform....</h1>
           
        <div style="width:25%">
        <input type="hidden" value="{{$identifier}}" disabled="disabled"/>
       
        <input type="text" value="{{$newTotal}}" disabled="disabled" id="newamount"/>
        <form action="/{{$identifier}}/charge" method="POST">
        {{csrf_field()}}
        <script
